...
const nishanth = {
  role: "Developer",
  location: "Gotham City (Code Edition)",
  mission: "Building the web, one line at a time",
  skills: {
    languages: ["HTML", "CSS", "JavaScript"],
    tools: ["Linux", "Kali Linux"],
    superpower: "Turning caffeine into code"
  },
  status: "Always watching, always coding"
};
```
...
|:---:|:---:|
| ![HTML](https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&logo=html5&logoColor=white) | ![Linux](https://img.shields.io/badge/Linux-FCC624?style=for-the-badge&logo=linux&logoColor=black) |
| ![CSS](https://img.shields.io/badge/CSS3-1572B6?style=for-the-badge&logo=css3&logoColor=white) | ![Kali](https://img.shields.io/badge/Kali_Linux-557C94?style=for-the-badge&logo=kali-linux&logoColor=white) |
...
- 🛡️ Mastering Linux security tools
- 🌐 Exploring advanced JavaScript techniques
- 🦇 Protecting the internet from bugs and vulnerabilities
...
## 🎮 INTERACTIVE BATMAN SNAKE GAME

Want to see the Dark Snake in action? Check out my custom **[Batman-themed contribution snake visualization](#)**!

*Features:*
- 🦇 Dark Gotham aesthetic with golden accents
- 💫 Glowing bat-signal effects
- 🌃 Atmospheric fog and shadows
- 📊 Real-time "Crimes Stopped" tracker

## 🌐 CONNECT WITH THE DETECTIVE

<div align="center">

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/nishanth0007)
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)](https://leetcode.com/u/Nishanthalagu/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:nishanthalagumuthu@gmail.com)
